<template>
  <div class="partner-page">
    ...
    <!-- Hero Section -->
    <section class="hero">
      <h1 data-aos="fade-down" data-aos-duration="1200">Grow Your<br><span>Business</span></h1>
    ...
    <section class="why-partner">
      <div class="container">
        <h2 class="section-title" data-aos="fade-down">Why Partner With JamboApp?</h2>
        <p class="section-subtitle" data-aos="fade-up" data-aos-delay="100">Join hundreds of successful merchants growing their business on our platform</p>
        <div class="benefits-grid">
          <div class="benefit-card" v-for="(benefit, index) in benefits" :key="index" :data-aos="index % 2 === 0 ? 'fade-right' : 'fade-left'" :data-aos-delay="200 + (index * 100)">
        ...
        <div class="business-orbit">
          <div class="orbit-center">
            <div class="center-logo">
              ...
              <span>Your Business + JamboApp</span>
            </div>
          </div>
    ...
    <section class="partner-requirements">
      <div class="container">
        <h2 class="section-title" data-aos="fade-down">Getting Started Is Easy</h2>
        <p class="section-subtitle" data-aos="fade-up" data-aos-delay="100">Just a few things you'll need to begin your journey with us</p>
          ...
          <div class="requirements-timeline-side" data-aos="fade-left" data-aos-duration="1000">
            <div class="requirements-timeline">
              <div class="timeline-track">
                <div v-for="(req, index) in partnerRequirements" :key="index" class="timeline-node" :data-aos="'fade-up'" :data-aos-delay="200 + (index * 150)">
      ...
      <div class="container">
        ...
        <div class="faq-columns">
          <div class="faq-column">
            <div class="faq-item" v-for="(faq, index) in faqs.slice(0, 5)" :key="index" :class="{ active: activeFaq === index }" @click="toggleFaq(index)" :data-aos="'fade-right'" :data-aos-delay="100 + (index * 100)">
          ...
          <div class="faq-column">
            <div class="faq-item" v-for="(faq, index) in faqs.slice(5, 10)" :key="index + 5" :class="{ active: activeFaq === index + 5 }" @click="toggleFaq(index + 5)" :data-aos="'fade-left'" :data-aos-delay="100 + (index * 100)">
              <div class="faq-question">
    ...
    <section class="cta-section">
      <div class="container">
        <h2 data-aos="zoom-in">Ready to Grow Your Business?</h2>
        <p data-aos="fade-up" data-aos-delay="200">Partner with JamboApp today and reach thousands of new customers</p>

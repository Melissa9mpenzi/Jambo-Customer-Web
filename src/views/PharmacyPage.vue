  ...
  <div>
    ...
    <main>
      <section class="page-hero">
        <h1>{{ t('pharmacy.heroLine1') }}<br><span>{{ t('pharmacy.heroLine2') }}</span></h1>
      ...
      <section class="category-page-section">
        <div class="category-breadcrumb">
          ...
          <span class="breadcrumb-current">{{ t('pharmacy.heroLine1') }}</span>
        </div>
        <div class="subcategory-intro">
          <h3>{{ t('category.browseBy') }}</h3>
          <p>{{ t('pharmacy.intro') }}</p>
        </div>
        <div class="subcategory-grid">
          <div class="subcategory-card" v-for="cat in pharmacyCats" :key="cat.icon">
...
const pharmacyCats = computed(() =>
  translations.pharmacy.cats.map(c => ({
    icon: c.icon,

  ...
  <div>
    ...
    <main>
      <section class="page-hero">
        <h1>{{ t('food.heroLine1') }}<br><span>{{ t('food.heroLine2') }}</span></h1>
      ...
      <section class="category-page-section">
        <div class="category-breadcrumb">
          ...
          <span class="breadcrumb-current">{{ t('food.heroLine1') }}</span>
        </div>
        ...
        <div class="subcategory-grid">
          <div class="subcategory-card" v-for="cat in foodCats" :key="cat.icon">
...
const foodCats = computed(() =>
  translations.food.cats.map(c => ({
    icon: c.icon,

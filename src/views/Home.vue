<template>
  <div>
    ...
    <main>
      <section class="hero">
        <h1 data-aos="fade-down" data-aos-duration="1200">Ukitupata, <br><span>Umepata</span></h1>
      ...
      <section class="content-section">
        <div class="text-content" data-aos="fade-right" data-aos-duration="1000">
          ...
          <div class="signature" data-aos="fade-up" data-aos-delay="300">Good Food Fast</div>
        </div>
      ...
      <section class="foods-menu">
        <h2 data-aos="fade-down">TOP CATEGORIES</h2>
        <p data-aos="fade-up" data-aos-delay="100">Find everything you need in one place — food, groceries, essentials, and more — delivered quickly to your doorstep.</p>
      ...
      <section class="red-banner">
        ...
        <div class="red-banner-content">
          ...
          <div class="banner-center-content" data-aos="fade-left" data-aos-delay="200">
      ...
      <section class="join-us-section">
        <div class="join-us-header" data-aos="fade-down">
          <p style="text-transform: uppercase; letter-spacing: 2px; font-size: 0.85rem; margin-bottom: 12px; font-weight: 700; color: #14407b;">Join Us</p>
          <h2>Grow With JAMBOAPP</h2>
        ...
        <div class="join-us-grid">
            <div class="join-card" data-aos="flip-left" data-aos-delay="200">
            ...
            <div class="join-card" data-aos="flip-up" data-aos-delay="300">
            ...
            <div class="join-card" data-aos="flip-right" data-aos-delay="400">

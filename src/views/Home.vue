    ...
    <main>
      ...
      <section class="content-section">
        ...
        <div class="image-gallery">
          <img src="/images/rest.jpg" class="main-hall-img" alt="Restaurant interior with warm lighting and wooden tables">
          <div class="overlay-img"><img src="/images/rant.jpg" alt="Close up of delicious meal"></div>
        </div>
      </section>
      ...
      <section class="red-banner">
        ...
        <img src="/images/pizza.png" class="pizza-slice-big" alt="Large pizza slice with melting cheese">

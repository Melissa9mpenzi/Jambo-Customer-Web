<template>
  <div>
    ...
    <main>
      <section class="hero">
        <h1 data-aos="fade-down" data-aos-duration="1200">{{ t('home.hero.line1') }}<br><span>{{ t('home.hero.line2') }}</span></h1>
        ...
        <img src="/images/wine.png" class="food-item broccoli-left-2" alt="Pepper" data-aos="fade-up-left" data-aos-delay="650">
      ...
      <section class="content-section">
        <div class="text-content" data-aos="fade-right" data-aos-duration="1000">
          ...
          <p>{{ t('home.contentSection.body2') }}</p>
          <div class="signature" data-aos="fade-up" data-aos-delay="300">{{ t('home.contentSection.signature') }}</div>
        </div>
      ...
      <section class="foods-menu">
        <h2 data-aos="fade-down">{{ t('home.categories.title') }}</h2>
        <p data-aos="fade-up" data-aos-delay="100">{{ t('home.categories.subtitle') }}</p>
      ...
      <section class="red-banner">
        ...
        <div class="red-banner-content">
          <div class="left-image-wrapper" data-aos="fade-right">
            <img src="/images/shops.png" alt="Juicy burger with fresh toppings">
          </div>

  ...
  <div>
    ...
    <main>
      <section class="page-hero">
        <h1>{{ t('shops.heroLine1') }}<br><span>{{ t('shops.heroLine2') }}</span></h1>
        ...
        <img src="/images/shops.png" class="hi s1" alt="Shop">
        <img src="/images/shops.png" class="hi s4" alt="Shop">
      </section>
      ...
      <section class="category-page-section">
        <div class="category-breadcrumb">
          ...
          <span class="breadcrumb-current">{{ t('shops.heroLine1') }}</span>
        </div>
        ...
        <div class="subcategory-grid">
          <div class="subcategory-card" v-for="cat in shopsCats" :key="cat.icon">
...
const shopsCats = computed(() =>
  translations.shops.cats.map(c => ({
    icon: c.icon,
